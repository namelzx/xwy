      ...
      <el-card class="box-card">
        ...
        <div class="item">
          <div class="item-list">
            ...
            <div class="schedule">
              <el-progress :color="customColor" :percentage="homeData.fales_temp.all_failure_price"></el-progress>
            </div>
          </div>
        </div>
        <div class="item">
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      getCuntslist(getCommunity()).then(response => {
