<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-tag type="success">今日已收金额:{{truesum}}</el-tag>
      <el-tag type="warning">已缴纳笔数:{{ordercount}}</el-tag>
    </div>
    <div class="teables">
        ...
        <div class="teablist">
            <div class="teables-list" v-for="(item,index) in list" :key="index">
                <div class="list-day">
                    ...
                    <div class="day-name">{{item.实收电梯维保费}}</div>
            ...
            <!-- <div class="taebles-total">
                <div class="total-name">合计</div>
